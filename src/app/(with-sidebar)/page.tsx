    ...
    <RangeTransitionProvider>
      <div className="p-6">
        <div className="md:w-[90%] mx-auto text-[13px] text-(--analytics-t1) space-y-3.5">
          ...
          {/* RangeTransitionSwap covers the range-change case: router.push
              on an already-revealed page is a transition update, and React
              keeps stale content on screen through those rather than
              re-showing a Suspense fallback. Suspense still covers the
              first-load case, where the page mounts fresh. */}
    ...
    <>
      <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
        ...
        {data.errors.orders ? (
          ...
          <Link href={`/reports/orders?${rangeQuery}`} className="block h-full">
            <SummaryMetricCard
              title="Orders"
            ...
            <TimeSeriesChart
              ...
              headline={{
                value: formatCurrency(
                  data.summaryCards.averageOrderValue.value,
                ),
                changePercentage:
